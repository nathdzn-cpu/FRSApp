      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="login">
            <Card>
              <CardHeader>
                <CardTitle>Login to HOSS</CardTitle>
              ...
              <CardContent>
                <Form {...loginForm}>
                  <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                    ...
                    {loginError && <p className="text-sm text-red-500 text-center pt-2">{loginError}</p>}
                  </form>
                </Form>
              </CardContent>
            </Card>
          ...
          <TabsContent value="signup">
            <Card>
              <CardHeader>
                <CardTitle>Sign Up for HOSS</CardTitle>
                <CardDescription>Create a new organisation account.</CardDescription>
              </CardHeader>
              <CardContent>
                {signUpSuccess ? (
                  <Alert className="border-green-500 bg-green-50 text-green-900">
                    ...
                    <AlertDescription>
                      ...
                      <Button className="w-full mt-4" onClick={() => setActiveTab('login')}>
                        Proceed to Login
                      </Button>
                    </AlertDescription>
                  </Alert>
